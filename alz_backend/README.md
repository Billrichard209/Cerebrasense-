...
If the cases are escalated and need to be handed off cleanly for specialist
follow-up, build one handoff folder that gathers the escalated CSV, copied
prediction payloads, and the key review summaries:
